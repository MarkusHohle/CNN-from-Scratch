...
plt.imshow(Conv1.output[:,:,1,4]) 
plt.show()
plt.imshow(MP1.output[:,:,1,4])
plt.show()
plt.imshow(Conv2.output[:,:,1,4])
plt.show()
plt.imshow(MP2.output[:,:,1,4])
plt.show()
plt.imshow(Conv3.output[:,:,1,4])
plt.show()
plt.imshow(MP3.output[:,:,1,4])
plt.show()
...
plt.imshow(Conv1.dinputs[:,:,1,4]) 
plt.show()
plt.imshow(MP1.dinputs[:,:,1,4])
plt.show()
plt.imshow(Conv2.dinputs[:,:,1,4])
plt.show()
plt.imshow(MP2.dinputs[:,:,1,4])
plt.show()
plt.imshow(Conv3.dinputs[:,:,1,4])
plt.show()
plt.imshow(MP3.dinputs[:,:,1,4])
plt.show()
